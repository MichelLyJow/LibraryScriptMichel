...
-- FUNGSI UNTUK MENUTUP GUI SEBELUM LOAD SCRIPT BARU
...
Tabs.Main:Button({
    ...
    Callback = function()
        CloseAllGUI()
        loadstring(game:HttpGet('https://pastefy.app/1KRuf8dp/raw'))()
    end
})
...
Tabs.Main:AddButton({
    ...
    Callback = function()
        CloseAllGUI()
        loadstring(game:HttpGet('https://pastefy.app/oy9phVcm/raw'))()
    end
})
